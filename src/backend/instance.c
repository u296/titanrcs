...
const char* extensions[N_BASE_EXT] = {VK_EXT_DEBUG_UTILS_EXTENSION_NAME,
                                      VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME};

static VKAPI_ATTR VkBool32 VKAPI_CALL debug_callback(
    VkDebugUtilsMessageSeverityFlagBitsEXT severity, VkDebugUtilsMessageTypeFlagsEXT message_type,
