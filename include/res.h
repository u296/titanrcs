...
//#define TR_DOWNSCALE_PIX_PER_THREAD (1)

#if RCS_RESOLUTION == 16384
#define TR_FIRST_DOWNSCALESIZE (32)
#define TR_SECOND_DOWNSCALESIZE (16)
#endif

#if RCS_RESOLUTION == 8192
#define TR_FIRST_DOWNSCALESIZE (32)
#define TR_SECOND_DOWNSCALESIZE (8)
#endif
...
#if 32*TR_FIRST_DOWNSCALESIZE*TR_SECOND_DOWNSCALESIZE != RCS_RESOLUTION
#error MATH ERROR: DOWNSCALES DONT ALIGN
#endif

#if RCS_RESOLUTION&(RCS_RESOLUTION-1)
